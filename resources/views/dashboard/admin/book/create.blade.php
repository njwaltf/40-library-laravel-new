...
@section('main')
    <section class="section">
        ...
        <form action="/books-management" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-lg-9">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-4">
                                        <label for="category_id" class="form-label">Genre Buku</label>
                                        ...
                                        {{-- <select class="form-select @error('category_id') is-invalid @enderror"
                                            aria-label="Default select example" id="category_id" name="category_id">
                                            @forelse ($categories as $item)
                                                <option value="{{ $item->id }}">{{ $item->name }}</option>
                                            @empty
                                                <option value="">Belum ada kategori</option>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-4">
                                        ...
                                        <textarea class="summernote-simple" name="desc">{{ old('desc') }}</textarea>
                                        @error('desc')
                                            <p class="invalid" style="color: red">
                                                {{ $message }}
                                            </p>
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="mb-4">
                                        ...
                                        <div class="form-text text-muted">Ukuran file maximal 10MB</div>
