...
@section('main')
    <section class="section">
        <div class="section-header">
            <h1><a href="javascript:history.go(-1);"><i class="fas fa-arrow-left"></i></a> &nbsp;Detail Peminjaman</h1>
        </div>
        <style>
            .invalid {
                color: red;
            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body p-3">
                        <div class="row my-3">
                            <div class="col-lg-6">
                                <strong class="m-1">Kode Peminjaman</strong>
                            </div>
                            <div class="col-lg-6">
                                <p class="m-1"><strong>{{ $booking->booking_code }}</strong></p>
                            </div>
                        </div>
                        <div class="row my-3">
                            <div class="col-lg-6">
                        ...
                        <div class="row my-3">
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <span
                                    @if ($booking->isDenda === 1) class="badge badge-danger rounded-3 fw-semibold" @else class="badge badge-success rounded-3 fw-semibold" @endif>
                ...
                <div class="col-lg-7">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            {!! QrCode::size(250)->generate('http://127.0.0.1:8000/bookings-management/' . $booking->id . '/edit') !!}
                            {{-- btn add --}}
                            {{-- @if (auth()->user()->role === 'admin') --}}
                            <a class="btn btn-info my-3" href="{{ url('/qr/export-booking/' . $booking->id) }}">Export QR
                                PDF <i class="ti ti-file-text"></i></a>
                            <a class="btn btn-primary my-3" href="{{ url('/export/invoice/' . $booking->id) }}">Generate
                                Invoice
